...
*   [ ] Confirm real tech stack for the new bird app web platform (e.g. Next.js? plain React? something else?) and the CSV/Excel import library used. (No spec doc supplied yet for this one — ask user directly or provide docs.)
